...
<tbody>
    ...
    <tr>
        <td><span class="bleu">Vous venez avec nous? (/ avec moi?)</span></td>
        <td><span class="noir">一緒にきませんか？</span></td>
        <td><span class="noir">ヴ・ヴネ・アヴェク・ヌ？（／アヴェク・モワ？）</span></td>
        <td></td>
    </tr>
    <tr>
