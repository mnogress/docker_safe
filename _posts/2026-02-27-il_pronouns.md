...
---
il, ill が含まれる単語の発音をまとめました。<!--more-->つづり字を間違いやすいところです。　正しい発音とつづり字を覚えましょう。
...
<tr>
    ...
    <td>
      <ul>
        <li><span class="bleu">il</span> (イル)</li>
        <li><span class="bleu">ils</span> (イル)</li>
        <li>avr<span class="bleu">il</span> (アヴリル)</li>
        <li>pér<span class="bleu">il</span> (ペリル)</li>
        <li>c<span class="bleu">il</span> / c<span class="bleu">il</span>s (スィル)</li>
        <li>fac<span class="bleu">il</span>e (ファシル)</li>
...
<tr>
    ...
    <td>
      <ul>
        ...
        <li>out<span class="bleu">il</span> (ウティ)</li>
      </ul>
    </td>
    <td>
      <div class="player">
...
<tr>
    ...
    <td>
      <ul>
        <li>le maqu<span class="bleu">ill</span>age (ル・マキヤージュ)</li>
        <li>une f<span class="bleu">ill</span>e (ラ・ファミーユ)</li>
        <li>le maqu<span class="bleu">ill</span>e (ウヌ　フィーユ)</li>
        <li>une grenou<span class="bleu">ill</span>e (ウヌ　グルヌイユ)</li>
        <li>une boute<span class="bleu">ill</span>e (ウヌ　ブテイユ)</li>
        <li>à la van<span class="bleu">ill</span>e (ア・ラ・ヴァニィユ)</li>
        <li>une ratatou<span class="bleu">ill</span>e (ウヌ　ラタトゥイユ)</li>
        <li>hab<span class="bleu">ill</span>é (アビーユ)</li>
        <li>gent<span class="bleu">ill</span>e (ジャンティーユ)</li>
      </ul>
    </td>
    <td>
      <div class="player">
...
<tr>
    ...
    <td>
      <ul>
        <li>la v<span class="bleu">ill</span>e (ラ・ヴィル)</li>
        <li>m<span class="bleu">ill</span>e (ミル)</li>
        <li>tranqu<span class="bleu">ill</span>e (トランキール)</li>
      </ul>
    </td>
    <td>
      <div class="player">
